...
class SpinGameInitArgs {
    ...
    */
    get x_position() {
        const ret = wasm.__wbg_get_spingameinitargs_x_position(this.__wbg_ptr);
    ...
    */
    set x_position(arg0) {
        wasm.__wbg_set_spingameinitargs_x_position(this.__wbg_ptr, arg0);
    }
    /**
    * @returns {bigint}
    */
    get y_position() {
        const ret = wasm.__wbg_get_spingameinitargs_y_position(this.__wbg_ptr);
        return BigInt.asUintN(64, ret);
    }
    /**
    * @param {bigint} arg0
    */
    set y_position(arg0) {
        wasm.__wbg_set_spingameinitargs_y_position(this.__wbg_ptr, arg0);
    }
    /**
    * @returns {bigint}
    */
    get highscore() {
        const ret = wasm.__wbg_get_spingameinitargs_highscore(this.__wbg_ptr);
        return BigInt.asUintN(64, ret);
    }
    /**
    * @param {bigint} arg0
